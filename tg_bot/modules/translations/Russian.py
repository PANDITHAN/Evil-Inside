...
*Только админы:*
 ...
 - /welcomesecurity <off/soft/hard>: soft - ограничить пользователя отправлять медиафайлы в течение 24 часов, hard - ограничить пользователя отправлять сообщения, пока он не нажимает кнопку \"Я не бот\".""".format(
